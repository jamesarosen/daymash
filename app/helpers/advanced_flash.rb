  ...
  module Helper
    ...
    def flash_text(v)
      ...
      when DELETED_CREDENTIAL_FLASH
        ...
        form = inline_button_to(t('common.undo'), undestroy_user_credential_path(current_user, deleted_credential_id), :put, :class => 'ajax')
      ...
      when DELETED_CALENDAR_FLASH
        ...
        form = inline_button_to(t('common.undo'), undestroy_user_calendar_path(current_user, deleted_calendar_id), :put, :class => 'ajax')
